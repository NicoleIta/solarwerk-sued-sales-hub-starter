...
function NeuerPipelineEintragForm({ activeUsers, currentUserId, currentUserRole }: Props) {
...
export default function NeuerPipelineEintragFormWrapper(props: Props) {
  return (
    <Suspense>
      <NeuerPipelineEintragForm {...props} />
    </Suspense>
  );
}
